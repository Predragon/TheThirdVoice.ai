...
show_api_config = not st.session_state.api_key_validated or not st.session_state.gemini_api_key
                ...
                if not st.session_state.api_key_validated:
                    ...
                    with st.spinner("⚡ AI is analyzing your message..."):
                        ...
                        with col2:
                            ...
                            # Alternative copy method using text area (read-only)
                            st.text_area(
                                "Copy this reframed message:",
                                value=reframed,
                                height=100,
                                key="reframe_copy_area",
        ...
        if received_message.strip():
            if not st.session_state.api_key_validated:
                ...
                with st.spinner("⚡ AI is analyzing the emotional subtext..."):
                    ...
                    st.text_area(
                        "Copy this emotional translation:",
                        value=translation,
                        height=150,
                        key="translation_copy_area",
                        help="Select all (Ctrl+A) and copy (Ctrl+C)"
                    )
        else:
